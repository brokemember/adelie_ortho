 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  GUI | Alt  |Arrows| Lower| Space|Space |Raise |OS_Meh| TT(7)|  Esc | Left | Down | Right|
 * `-------------------------------------------------------------------------------------------------'
 */
[0] = LAYOUT_ergo(
    KC_TAB,  KC_Q,    KC_W,    KC_F,   KC_P,  KC_G,   KC_J,   KC_L,   KC_U,    KC_Y,    KC_SCLN, KC_MINS,   KC_BSPC,    KC_DEL,
